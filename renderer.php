...
class format_proa_renderer extends format_section_renderer_base {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_proa_renderer::section_edit_control_items() only displays the 'Highlight' control when editing mode is on
    ...
    protected function section_summary($section, $course, $mods) {
        ...
        $style = 'background: url("'.$sectionimage.'") no-repeat; background-size: cover;';
     ...
     */
    protected function get_section_image_url($course, $section) {
        global $CFG;

        $file = format_proa_get_file('sectionimage' . $section->id, $course);

        if (!$file) {
            return $CFG->wwwroot . '/course/format/proa/pix/default_section.jpg';
        }
