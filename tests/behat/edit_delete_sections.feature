@format @format_proa
Feature: Sections can be edited and deleted in proa format
  ...
  @javascript
  Scenario: Inline edit section name in proa format
  ...
  Scenario: Deleting the last section in proa format
  ...
  Scenario: Deleting the middle section in proa format
  ...
  @javascript
  Scenario: Adding sections in proa format
